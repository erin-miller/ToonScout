 ...
 */
export type TaskCategory = 'matchable' | 'stf_grinding' | 'just_for_fun' | 'deletable' | 'toontorial' | 'random_reward'
...
export type TasklineFilterStageName = 'all' | 'playground' | 'npc_taskline' | 'first_step' | 'reward' | 'numeric'
