...
const buildingIndex: Map<string, { neighborhood: string; street: string; data: BuildingData }> = new Map()
...
const STREET_CALIBRATION: Record<
  string,
  {
...
function scaleMarkerPosition(position: MarkerPosition | null, street: string): MarkerPosition | null {
...
export function getBuildingMapInfo(buildingName: string): BuildingMapInfo | null {
