...
import { cogNameMap, normalizeCogName, findCogInText, containsCog, stripCogVariant, getAllCogs } from './cogNames'
...
export function getCogImage(cogName: string): StaticImageData | undefined {
  ...
  const cog = cogsData.find((c: any) => c.name === canonical || c.fullname === canonical)
