          ...
          return (
            ...
            >
              <div className="hidden sm:flex lg:hidden xl:flex flex-col px-2">
                ...
                >
                  <div className="text-black opacity-70 rounded-lg">{track}</div>
                </h3>
                    ...
                    >
                      ...
                      {isImageVisible && (
                        ...
                        >
                          <div
                            className={
                              'absolute inset-0 border-2 border-b-8 opacity-5 border-solid rounded-3xl pointer-events-none'
                            }
                            style={{
                              borderColor: 'white'
                            }}
                          ...
                          <div
                            className={
                              'absolute inset-0 border-4 border-t-8 opacity-5 border-solid rounded-3xl pointer-events-none'
                            }
                            style={{
                              borderColor: 'white'
                            }}
