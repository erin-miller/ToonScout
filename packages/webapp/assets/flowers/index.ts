...
export const flowerImages: Record<string, StaticImageData> = {
  ...
  chili_lily: Chili_Lily,
  chim_pansy: Chim_Pansy,
  corn_rose: Corn_Rose,
  crazy_daisy: Crazy_Daisy,
  daffy_dill: Daffy_Dill,
  dandy_pansy: Dandy_Pansy,
  dilly_lilly: Dilly_Lilly,
  freshasa_daisy: Freshasa_Daisy,
  giraff_o_dil: Giraff_o_dil,
  hazy_dazy: Hazy_Dazy,
  hybrid_carnation: Hybrid_Carnation,
  indubitab_lily: Indubitab_Lily,
  instant_carnation: Instant_Carnation,
  istilla_rose: Istilla_Rose,
  laff_o_dil: Laff_o_dil,
  lazy_daisy: Lazy_Daisy,
  lily_pad: Lily_Pad,
  lily_of_the_alley: Lily_of_the_Alley,
  livered_lily: Livered_Lily,
  marzi_pansy: Marzi_Pansy,
  midsummer_daisy: Midsummer_Daisy,
  model_carnation: Model_Carnation,
  onelip: Onelip,
  platoonia: Platoonia,
  potsen_pansy: Potsen_Pansy,
  school_daisy: School_Daisy,
  side_carnation: Side_Carnation,
  silly_lily: Silly_Lily,
  smarty_pansy: Smarty_Pansy,
  stinking_rose: Stinking_Rose,
  summers_last_rose: Summers_Last_Rose,
  threelip: Threelip,
  tiger_lily: Tiger_Lily,
  time_and_a_half_o_dil: Time_and_a_half_o_dil,
  tinted_rose: Tinted_Rose,
  twolip: Twolip,
